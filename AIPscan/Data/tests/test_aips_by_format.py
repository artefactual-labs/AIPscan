...
def test_aips_by_file_format(mocker, query_results, results_count):
    """Test that return value conforms to expected structure.
    """
    mock_query = mocker.patch("AIPscan.Data.data._aips_by_format_query")
...
def test_aips_by_file_format_elements(mocker, test_aip):
