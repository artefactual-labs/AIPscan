...
* `TYPESENSE_API_KEY="xOxOxOxO" ./tools/index-refresh  # Index AIPscan data`
* `TYPESENSE_API_KEY="xOxOxOxO" ./tools/index-summary  # Show index summary`
* `TYPESENSE_API_KEY="xOxOxOxO" python run.py  # Sepecify Typesense API key`
